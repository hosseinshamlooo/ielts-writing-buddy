...
export default function HighlightedEssay({
  ...
  return (
    <div
      ref={containerRef}
      className="border rounded-lg w-[95%] resize-none h-[38rem] p-4 overflow-y-auto whitespace-pre-wrap leading-relaxed"
    >
            ...
            <span
              ...
              className={`${
                segment.highlight === "needs-improvement"
                  ? isFocused
                    ? "bg-orange-300 dark:bg-orange-800/60 underline decoration-4 decoration-orange-500 dark:decoration-orange-400 border-2 border-orange-500 dark:border-orange-400 font-semibold"
                    : "bg-yellow-200 dark:bg-yellow-900/40 underline decoration-2 decoration-yellow-600 dark:decoration-yellow-400"
                  : isFocused
                  ? "bg-emerald-300 dark:bg-emerald-800/60 border-2 border-emerald-500 dark:border-emerald-400 font-semibold"
